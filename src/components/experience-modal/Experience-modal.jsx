    ...
    <>
      ...
      >
        <div className="modal-header">
          <div className="modal-heading">{experience.title}</div>
          <button className="close-button" onClick={onClose}>
            X
          </button>
        </div>
        <div className="modal-experience">
          <div className="modal-experience-company">{experience.company}</div>
          <div className="modal-experience-duration">{experience.duration}</div>
        </div>
