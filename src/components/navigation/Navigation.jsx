  ...
  if (isMobileView) {
    return (
      <section id="main-content">
            ...
            >
              <ul className="nav-container-items">
                ...
                <li
                  ...
                  className={activeNavItem === "Certificates" ? "active" : ""}
                >
                  Certificates
                </li>
                <li
        ...
        <main>
          <About />
          <div id="skills-heading" className="section-heading">
            Skills
          </div>
          <Skills />
          <div id="experience-heading" className="section-heading">
            Experience
          </div>
          <Experiance />
          <div id="projects-heading" className="section-heading">
            Projects
          </div>
          <Projects />
          <div id="certificates-heading" className="section-heading">
            Certificates
          </div>
          <Certificates />
